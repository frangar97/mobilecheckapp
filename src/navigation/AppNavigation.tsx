...
import { ClienteCreateScreen, ClienteDetailScreen, ClienteListScreen, DashboardScreen, MainMenuScreen, TareaListScreen, VisitaClienteListScreen, VisitaCreateScreen, VisitaListScreen } from "../screens";
