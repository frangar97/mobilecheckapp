...
import { ClienteCreateScreen, ClienteDetailScreen, ClienteListScreen, MainMenuScreen, VisitaClienteListScreen, VisitaCreateScreen, VisitaListScreen } from "../screens";
